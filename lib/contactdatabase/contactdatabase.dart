...
class ContatcDataBaseHandler {
  ...
  Future<Database> getDataBase() async {
    ...
    String path = join(await getDatabasesPath(), 'muContacts.db7');
    ...
    return await openDatabase(
      ...
      onCreate: (Database db, int version) async {
        await db.execute(
            'CREATE TABLE $contactTable ($idColumn INTEGER PRIMARY KEY AUTOINCREMENT, $nameColumn TEXT , $numberColumn TEXT,$titleColors TEXT,$images TEXT ,$NUMBEROFCATOGRIES TEXT   )');
      },
    );
  }
...
// CRUD
  ...
  Future<ContactModel> getContactFromDataBaseById(int id) async {
    ...
    if (allData.isNotEmpty) {
      ...
      return ContactModel(name: '', number: '', titleColorOfCatogries: '', img: '', numberOfCatogries: '', );
    }
  }
